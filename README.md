...
> [!NOTE]
> Эта версия специально создавалась для поддержки Windows 7+ (_включай 32-битную_) и выше!
...
### Как запускать
1. Для выбора пресетов запустите `zapret-console.bat`. Перед этим закройте все остальные окна Запрета!
2. Если нужно настроить или включить блокчек воспользуйтесь файлом `service.bat`.
